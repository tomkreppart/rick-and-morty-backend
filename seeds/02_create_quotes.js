    ...
    .then(function () {
      ...
      return knex('quotes').insert([
        ...
        // },
        {
          ...
          soundUrl: "../soundclips/Beth_I_squanch_my_family.wav"
        },
        {
          character_id: 2,
          content: `"I'm going out..."`,
          soundUrl: "../soundclips/Beth_im_going_out.wav"
        },
        {
          character_id: 2,
          content: `"Why expend the effort?"`,
          soundUrl: "../soundclips/Beth_why_expend_the effort.wav"
        },
        // {
        //   character_id: 3,
        ...
        // },
        {
          ...
          soundUrl: "../soundclips/Jerry_What_a_family.wav"
        },
        {
          character_id: 3,
          content: `"Life is effort and I'll stop when I die"`,
          soundUrl: "../soundclips/Jerry_Life_is_effort_and_Ill_stop_when_I_die.wav"
        },
        {
          character_id: 4,
          content: `"Oh man"`,
        ...
        },
        {
          ...
          soundUrl: "../soundclips/Summer_youre_holding_me_verbally_hostage.wav"
        },
        {
          character_id: 5,
          content: `"That's an intense line of questing, Snuffles"`,
          soundUrl: "../soundclips/Summer_thats_an_intense_line_of_questioning_snuffles.wav"
        },
        // {
        //   character_id: 5,
        ...
        // },
        {
          ...
          soundUrl: "../soundclips/Squanchy_squanching_party_bro.wav"
        },
        {
          character_id: 6,
          content: `"Hey, I'm Squanchin in here!"`,
          soundUrl: "../soundclips/Squanchy_im_squanchin_in_here.wav"
        },
        {
          character_id: 7,
        ...
        },
        {
          ...
          soundUrl: "../soundclips/Mr_Meeseeks_can_you_help_me_get_two_strokes_off_of_jerrys_golf_game.wav"
        },
        {
          character_id: 7,
          content: `"Existence is pain to a meeseeks Jerry, and we will do anything to alleviate that pain."`,
          soundUrl: "../soundclips/Mr_Meseeks_Existence_is_pain_to_a_Meeseeks.wav"
        },
        {
          character_id: 7,
          content: `"I JUST WANNA DIE!"`,
          soundUrl: "../soundclips/Mr_Meeseeks_i_just_wanna_die.wav"
        },
        {
          character_id: 7,
          content: `"None of us can die until our job is done!"`,
          soundUrl: "../soundclips/Mr_Meeseeks_none_of_us_can_die_until_our_job_is_done.wav"
        },
        {
          character_id: 7,
          content: `"Ooohh! We're well past that Jerry!"`,
          soundUrl: "../soundclips/Meeseeks_oh_were_well_pass_that_jerry.wav"
        },
        {
          character_id: 8,
        ...
        },
        {
          ...
          soundUrl: "../soundclips/Birdperson_My_people_have_another_saying.wav"
        },
        {
          character_id: 8,
        ...
        },
        {
          ...
          soundUrl: "../soundclips/Birdperson_tammy_I_was_approaching_infertility.wav"
        },
        {
          character_id: 8,
          content: `"Rick is in deep pain..."`,
          soundUrl: "../soundclips/Birdperson_Deep_Pain.wav"
        },
        {
          character_id: 8,
          content: `"In bird culture..."`,
          soundUrl: "../soundclips/Birdperson_in_bird_culture.wav"
        },
        {
          character_id: 9,
          content: `"Brad is here, quick make my hair look drunk!"`,
          soundUrl: ".../soundclips/Tammy_Quick_make_my_hair_look_drunk.wav"
        },
        {
          character_id: 9,
          content: `"Birdperson, you are my seed..."`,
          soundUrl: ".../soundclips/Tammy_birdperson_you_are_my_seed.wav"
        },
        {
          character_id: 9,
        ...
        },
        {
          ...
          soundUrl: ".../soundclips/Baby_legs_i_dont_need_no_regular_legs.wav"
        },
        {
          character_id: 10,
          content: `"I'm a good detective!"`,
          soundUrl: ".../soundclips/Baby_legs_im_a_good_detective.wav"
        },
        {
          character_id: 10,
          content: `"Baby Legs Running..."`,
          soundUrl: "../soundclips/Baby_legs_running.wav"
        },
        {
          character_id: 11,
          content: `"Oo-wee! I'm Hungry"`,
          soundUrl: "../soundclips/Mr_Poopy_Butthole_Hungry.wav"
        },
        {
          character_id: 11,
          content: `"Just like the Hulk Musical..."`,
          soundUrl: "../soundclips/Mr_Poopy_Butthole_Hulk_Musical.wav"
        },
        {
          character_id: 11,
          content: `"Oo-wee! Whatever you want Rick!"`,
          soundUrl: "../soundclips/Mr_Poopy_Butthole_whatever_you_want_rick.wav"
        },
        {
          character_id: 11,
          content: `"You're not in any of my photos..."`,
          soundUrl: "../soundclips/Mr_Poopy_Butthole_youre_not_in_any_of_my_photos.wav"
        },
        {
          character_id: 12,
          content: `"I'm Ants in my Eyes Johnson, everything's black, I can't see a thing..."`,
          soundUrl: "../soundclips/Ants_in_my_Eyes_Johnson_i_cant_see_anything.wav"
        },
        {
          character_id: 12,
          content: `"I also can't feel anything either!"`,
          soundUrl: "../soundclips/Ants_in_my_Eyes_Johnson_i_cant_feel_anything.wav"
        },
        {
          character_id: 13,
          content: `"I'm half Abraham Lincoln soooo..."`,
          soundUrl: "../soundclips/Abradolf_Lincler_im_half_abraham_lincoln_soooo.wav"
        },
        {
          character_id: 13,
          content: `"I have no qualm with you boy..."`,
          soundUrl: "../soundclips/Abradolf_Lincler_i_have_no_qualm_with_you_boy.wav"
        },
        {
          character_id: 13,
          content: `"Rick! You brought me into this world..."`,
          soundUrl: "../soundclips/Abradolf_Lincler_you_brought_me_into_this_world.wav"
        },
        // {
        //   character_id: 13,
        ...
        // },
        {
          ...
          soundUrl: "../soundclips/Brad_check_it_out_tammy_is_already_drunk_cool.wav"
        },
        {
          character_id: 14,
          content: `"I throw balls far. You want good words? Date a languager."`,
          soundUrl: "../soundclips/Brad_I_throw_balls_far.wav"
        },
        {
          character_id: 14,
          content: `"WHAT DO I KNOW?!?"`,
          soundUrl: "../soundclips/Brad_that_the_third_reich_will_reign_for_a_1000_years.wav"
        },
        {
          character_id: 14,
          content: `"Dude,stay in your league..."`,
          soundUrl: "../soundclips/Brad_dude_stay_in_your_league.wav"
        },
        {
          character_id: 14,
          content: `"Were you about to talk to her?"`,
          soundUrl: "../soundclips/Brad_were_u_about_to_talk_to_her.wav"
        },
        // {
        //   character_id: 15,
        ...
        // },
        {
          ...
          soundUrl: "../soundclips/Principal_Vagina_dont_let_the_name_fool_you_im_very_much_in_charge.wav"
        },
        // {
        //   character_id: 17,
        ...
        // },
        {
          ...
          soundUrl: "../soundclips/Principal_Vagina_no_relation.wav"
        },
        {
          character_id: 18,
          content: `"You can run but you can't hide, bitch!"`,
          soundUrl: "../soundclips/ScaryTerry_im_scary_terry_you_can_run_but_you_cant_hide_bitch.wav"
        },
        // {
        //   character_id: 18,
        ...
        },
        {
          character_id: 18,
           ...
           soundUrl: "../soundclips/ScaryTerry_welcome_to_your_nightmare_bitch.wav"
        },
        {
          character_id: 18,
           content: `"You're home early..."`,
           soundUrl: "../soundclips/ScaryTerry_You're_home_early.wav"
        },
        // {
        //   character_id: 19,
        ...
        // },
        {
          ...
          soundUrl: "../soundclips/Snuffles_where_are_my_testicles_summer_where_have_they_gone.wav"
        },
        {
          character_id: 20,
          content: `"We are not them, we are not them..."`,
          soundUrl: "../soundclips/Snuffles_We_are_not_them.wav"
        },
        {
          character_id: 20,
          content: `"Tell me Summer..."`,
          soundUrl: "../soundclips/Snuffles_tell_me_summer.wav"
        },
        {
          character_id: 20,
          content: `"Anything for my precious Morty..."`,
          soundUrl: "../soundclips/Snuffles_anything_for_my_precious_morty.wav"
        },
        {
          character_id: 20,
          content: `"DO NOT CALL ME THAT! Snuffles was my slave name..."`,
          soundUrl: "../soundclips/Snuffles_do_not_call_me_that_name_snuffles_was_my_slave_name.wav"
        },
        // {
        //   character_id: 20,
        ...
        // },
        {
          ...
          soundUrl: "../soundclips/Jessica_whats_up_morty.wav"
        },
        // {
        //   character_id: 31,
        //   content: `"Arthricia"`,
